...
// cut
type HawaiianRecipe struct{ PizzaIngredients }
...
func (r *HawaiianRecipe) Bake() Pizza{ return NewPizza(r.dough, r.sauces, r.toppings, r.cheeses) }
func (r *HawaiianRecipe) setDough(dough string) PizzaRecipe{ return r }
func (r *HawaiianRecipe) addSauce(sauce string) PizzaRecipe{ return r }
func (r *HawaiianRecipe) addTopping(topping string) PizzaRecipe{ return r }
func (r *HawaiianRecipe) addCheese(cheese string) PizzaRecipe{ return r }

type PepperoniRecipe struct{ PizzaIngredients }
...
func (r *PepperoniRecipe) Bake() Pizza{ return NewPizza(r.dough, r.sauces, r.toppings, r.cheeses) }
func (r *PepperoniRecipe) setDough(dough string) PizzaRecipe{ return r }
func (r *PepperoniRecipe) addSauce(sauce string) PizzaRecipe{ return r }
func (r *PepperoniRecipe) addTopping(topping string) PizzaRecipe{ return r }
func (r *PepperoniRecipe) addCheese(cheese string) PizzaRecipe{ return r }
// cut
